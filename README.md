...
<h1>4. Создание имени файла для директории в которой уже существует файл с таким именем путем добавления к имени файла последующей цифры в скобках</h1>
...
<p>Пример этой вы можете найти в файле <b>recursive_name.php</b></p>
